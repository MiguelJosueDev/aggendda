  ...
  const steps = [
    {
      ...
      description: "Los pacientes encuentran el dentista ideal según especialidad, ubicación y disponibilidad.",
      icon: Search,
      color: "text-[#5C9DF1]",
    ...
    },
    {
      ...
      description: "Se realiza un pequeño depósito que garantiza la asistencia a la cita.",
      icon: CreditCard,
      color: "text-[#6DD3A7]",
    ...
    },
    {
      ...
      description: "Sistema automatizado de recordatorios por email y SMS para evitar olvidos.",
      icon: Bell,
    ...
    },
    {
      ...
      description: "Gestión automática de asistencias y ausencias con políticas claras.",
      icon: User,
    ...
    },
    {
      ...
      description: "Proceso transparente de cobros y devoluciones según la política establecida.",
      icon: CheckCircle,
        ...
        <div ref={ref} className="relative max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            {steps.map((step, index) => (
              ...
              >
                <div className={`w-20 h-20 rounded-full ${step.bgColor} flex items-center justify-center mb-4 z-10`}>
